...
class BaseSettingsPage:
    ...
    def EnterButtonEditBoxEmail(self, locator):
        if str(locator).endswith("_ID"):
            ...
            self.driver.find_element_by_class_name(configreader.ConfigReader("locators", locator)).send_keys(
                Keys.RETURN)
        elif str(locator).endswith("_XPATH"):
    ...
    def AssertText(self, locator, expectedTextVal):
        if str(locator).endswith("_ID"):
            ...
            actualTextVal = self.driver.find_element_by_css_selector(
                configreader.ConfigReader("locators", locator)).text
            assert actualTextVal == expectedTextVal
            ...
            actualTextVal = self.driver.find_element_by_partial_link_text(
                configreader.ConfigReader("locators", locator)).text
            assert actualTextVal == expectedTextVal
